...
void SaveCmd();
void NameCmd();
//tambahan untuk konversi file 12 bit menjadi 10 bit pada servo AX
void ConvCmd();
//tambahan untuk konversi file 10 bit menjadi 12 bit pada servo MX
void InvCmd();
//tambahan untuk mencerminkan gerakan
void MirrorCmd();
#endif

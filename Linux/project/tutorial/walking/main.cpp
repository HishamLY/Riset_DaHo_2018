...
int main(void)
{
	...
	rgb_ball = LinuxCamera::GetInstance()->fbuffer->m_RGBFrame;
            ...
            //tempPan = MotionStatus::m_CurrentJoints.GetAngle(JointData::ID_HEAD_PAN);

	Walking::GetInstance()-> A_MOVE_AIM_ON = true;			
		//Walking::GetInstance()->X_MOVE_AMPLITUDE = 0;
		//Walking::GetInstance()->Y_MOVE_AMPLITUDE = 15;
		//Walking::GetInstance()->Z_MOVE_AMPLITUDE = 15;
		Walking::GetInstance()->A_MOVE_AMPLITUDE = 25;
	/*if(Walking::GetInstance()->GetCurrentPhase() == Walking::PHASE3)
	{

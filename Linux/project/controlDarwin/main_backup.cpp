...
int main(void)
{
  ...
  Image* map =  new Image(740, 540, Image::RGB_PIXEL_SIZE );
  if( jpeg_utils::read_jpeg_file( map, "Field.jpg" ) > 0 )
...
/*
        if (Head::GetInstance()->ReadCameraOrMap == 1)
            streamer->send_image(rgb_output);
        else{
            jpeg_utils::read_jpeg_file( map, "Field.jpg" );
            streamer->send_image(map,0);
        }
*/
    }

...
typedef enum{
    ...
    /*Camera Calibration*/
    IN_CMD_SAVE_CAMCALIB,
    IN_CMD_LOAD_CAMCALIB,
    IN_CMD_CAMROLL_SET,
    IN_CMD_CAMROLL_PLUS,
    IN_CMD_CAMROLL_MINUS,
    IN_CMD_CAMTILT_SET,
    IN_CMD_CAMTILT_PLUS,
    IN_CMD_CAMTILT_MINUS,
    IN_CMD_CAMPAN_SET,
    IN_CMD_CAMPAN_PLUS,
    IN_CMD_CAMPAN_MINUS,
    IN_CMD_BODYTILT_SET,
    IN_CMD_BODYTILT_PLUS,
    IN_CMD_BODYTILT_MINUS,
    IN_CMD_BODYROLL_SET,
    IN_CMD_BODYROLL_PLUS,
    IN_CMD_BODYROLL_MINUS,
    IN_CMD_BODYTRANSX_SET,
    IN_CMD_BODYTRANSX_PLUS,
    IN_CMD_BODYTRANSX_MINUS,
    IN_CMD_BODYTRANSY_SET,
    IN_CMD_BODYTRANSY_PLUS,
    IN_CMD_BODYTRANSY_MINUS,
    IN_CMD_BODYTRANSZ_SET,
    IN_CMD_BODYTRANSZ_PLUS,
    IN_CMD_BODYTRANSZ_MINUS,

        //edited for odometri tuning
    IN_CMD_WALK_X_ODOMETRI_GAIN,
    IN_CMD_WALK_Y_ODOMETRI_GAIN,
    IN_CMD_WALK_A_ODOMETRI_GAIN,
    IN_CMD_WALK_X_TUNNING,
    IN_CMD_WALK_Y_TUNNING,
    IN_CMD_WALK_A_TUNNING,

    //edited for control the robot manually
    IN_CMD_WALK_MOVE_FORWARD,
    IN_CMD_WALK_MOVE_BACKWARD,
    IN_CMD_WALK_MOVE_RIGHT,
    IN_CMD_WALK_MOVE_LEFT,
    IN_CMD_WALK_TURN_RIGHT,
    IN_CMD_WALK_TURN_LEFT,
    IN_CMD_WALK_START_STOP,
    IN_CMD_WALK_PAN_PLUS,
    IN_CMD_WALK_PAN_MINUS,
    IN_CMD_WALK_TILT_PLUS,
    IN_CMD_WALK_TILT_MINUS,
    IN_CMD_WALK_RESET,
    IN_CMD_WALK_KICK_LEFT,
    IN_CMD_WALK_KICK_RIGHT,

    //edited for cameraOrMap
    IN_CMD_GUI_CHANGEVIEW,
...
static const struct {
  ...
  { "walk_b_hip_pitch_gain", IN_CMD_WALK_B_HIP_PITCH_GAIN },
  ...
  { "reload_calib", IN_CMD_LOAD_CAMCALIB},
  { "save_calib", IN_CMD_SAVE_CAMCALIB},
  { "camroll_set", IN_CMD_CAMROLL_SET },
  { "camroll_plus", IN_CMD_CAMROLL_PLUS },
  { "camroll_minus", IN_CMD_CAMROLL_MINUS },
  { "camtilt_set", IN_CMD_CAMTILT_SET },
  { "camtilt_plus", IN_CMD_CAMTILT_PLUS},
  { "camtilt_minus", IN_CMD_CAMTILT_MINUS},
  { "campan_set",  IN_CMD_CAMPAN_SET},
  { "campan_plus", IN_CMD_CAMPAN_PLUS},
  { "campan_minus", IN_CMD_CAMPAN_MINUS},
  { "bodytilt_set", IN_CMD_BODYTILT_SET},
  { "bodytilt_plus", IN_CMD_BODYTILT_PLUS},
  { "bodytilt_minus", IN_CMD_BODYTILT_MINUS},
  { "bodyroll_set",  IN_CMD_BODYROLL_SET},
  { "bodyroll_plus", IN_CMD_BODYROLL_PLUS},
  { "bodyroll_minus", IN_CMD_BODYROLL_MINUS},
  { "bodytransx_set", IN_CMD_BODYTRANSX_SET},
  { "bodytransx_plus",IN_CMD_BODYTRANSX_PLUS },
  { "bodytransx_minus",IN_CMD_BODYTRANSX_MINUS },
  { "bodytransy_set",  IN_CMD_BODYTRANSY_SET},
  { "bodytransy_plus", IN_CMD_BODYTRANSY_PLUS},
  { "bodytransy_minus", IN_CMD_BODYTRANSY_MINUS},
  { "bodytransz_set",  IN_CMD_BODYTRANSZ_SET},
  { "bodytransz_plus", IN_CMD_BODYTRANSZ_PLUS},
  { "bodytransz_minus", IN_CMD_BODYTRANSZ_MINUS},

    //edited for odometri tuning
  { "walk_x_odometri_scale", IN_CMD_WALK_X_ODOMETRI_GAIN },
  { "walk_y_odometri_scale", IN_CMD_WALK_Y_ODOMETRI_GAIN },
  { "walk_a_odometri_scale", IN_CMD_WALK_A_ODOMETRI_GAIN },
  { "walk_x_tunning",IN_CMD_WALK_X_TUNNING },
  { "walk_y_tunning",IN_CMD_WALK_Y_TUNNING },
  { "walk_a_tunning",IN_CMD_WALK_A_TUNNING },

  //edited for controlling the robot manually
  { "walk_forward", IN_CMD_WALK_MOVE_FORWARD },
  { "walk_back", IN_CMD_WALK_MOVE_BACKWARD} ,
  { "walk_right",IN_CMD_WALK_MOVE_RIGHT},
  { "walk_left",IN_CMD_WALK_MOVE_LEFT},
  { "turn_right",IN_CMD_WALK_TURN_RIGHT},
  { "turn_left",IN_CMD_WALK_TURN_LEFT},
  { "start_stop",IN_CMD_WALK_START_STOP},
  { "pan_plus",IN_CMD_WALK_PAN_PLUS},
  { "pan_minus",IN_CMD_WALK_PAN_MINUS},
  { "tilt_plus",IN_CMD_WALK_TILT_PLUS},
  { "tilt_minus",IN_CMD_WALK_TILT_MINUS},
  { "reset_pan_tilt",IN_CMD_WALK_RESET},
  { "kick_left", IN_CMD_WALK_KICK_LEFT},
  { "kick_right", IN_CMD_WALK_KICK_RIGHT},

  { "CameraOrMap", IN_CMD_GUI_CHANGEVIEW},
};
...
public:
    ...
    static CameraCalibration* cam_finder;
    static CameraCalibration* cam_calibration;
    static char*        ini_section;
    static ColorFinder* ball_finder;
    static ColorFinder* field_finder;

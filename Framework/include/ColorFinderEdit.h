...
public:
  ...
  void Detect(Image * img, int r_min, int r_max, std::vector<Point2D> * center);

  void Accum_circle(int * accum, int i, int j, int rad, int * count);

  void Accum_pixel(int * accum, int x, int y, int * count);

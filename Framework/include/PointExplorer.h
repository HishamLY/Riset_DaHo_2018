...
#ifndef _POINTEXPLORER_H_
#define _POINTEXPLORER_H_
...
public:
  ...
  void initFrame( Image *image, int exploreStepSize, int gridStepSize, int skipOffset, int* minSegLength);
  ...
  int runDown(int x, int y, ColorClasses::Color col, int yEnd);
  ...
  int findDown(int x, int y, ColorClasses::Color col, int yEnd);
  ...
  int findDown2(int x, int y, ColorClasses::Color col1, ColorClasses::Color col2, int yEnd, ColorClasses::Color& foundCol);

  /**
   * Run up from (x,y) unless there is a run of skipOffset pixels with the color col1 or col2.
   * @param x x-coordiante to start from
   * @param y y-coordinate to start from
   * @param col1 the color to find
   * @param col2 the color to find
   ...
   * @return the first pixel (y-coordinate) followed by skipOffset pixels with the color col or yEnd
   */
  //int findUp2(int x, int y, ColorClasses::Color col1, ColorClasses::Color col2, int yEnd, ColorClasses::Color& foundCol, Drawings::PenStyle draw=Drawings::ps_null);
  int findUp2(int x, int y, ColorClasses::Color col1, ColorClasses::Color col2, int yEnd, ColorClasses::Color& foundCol);
  ...
  int runUp(int x, int y, ColorClasses::Color col, int yEnd);
  ...
  int runRight(int x, int y, ColorClasses::Color col, int xMax);
   ...
   * @param stepSize size of used step when selecting ratio
   * @return the percentage [0, 1] of the color on the image area
   */
  //ini pakai boundary coba cek lagi.
  ...
  Image* theImage; /**< a pointer to the image Representation */

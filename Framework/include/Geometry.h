...
{
public:
  struct Circle   /** Defines a circle by its center and its radius*/
  {
    Circle():radius(0) {}
  ...
  struct Line   /** Defines a line by two vectors*/
  {
    Vector2<> base;
    Vector2<> direction;
  ...
  public:
    ...
    float linearRegression(Line& line)
    {
      ...
      // reliability:
      return fabs(c3sum / sqrtf(c4sum * c5sum));
    }
  private:
...
public:
  ...
  */
  ...
  static float pixelSizeToAngleSize(float pixelSize);
  ...
  */
  ...
  static float angleSizeToPixelSize(float angleSize);
};
}

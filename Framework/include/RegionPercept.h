...
#ifndef _REGIONPERCEPT_H_
#define _REGIONPERCEPT_H_
...
*/
inline ColorRGB getOnFieldDrawColor(ColorClasses::Color color)
{
  switch(color)
    {
    case ColorClasses::black:
      return ColorRGB(ColorClasses::white);
      break;
    case ColorClasses::white:
      return ColorRGB(ColorClasses::black);
      break;
    case ColorClasses::none:
      return  ColorRGB(255, 0, 0);
      break;
    case ColorClasses::yellow:
      return ColorRGB(ColorClasses::blue);
      break;
    case ColorClasses::blue:
      return ColorRGB(ColorClasses::yellow);
      break;
...
public:
  ...
  bool debug_draw; /** want to draw the result or not */
